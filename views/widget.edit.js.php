...
window.widget_item_form = new class {
    ...
    init({thresholds_colors}) {
        this._form = document.getElementById('widget-form');
        ...
        this._time_period0 = document.getElementById('graphtimeperiod_data_source_0');
        this._time_period1 = document.getElementById('graphtimeperiod_data_source_1');
        this._time_period2 = document.getElementById('graphtimeperiod_data_source_2');

        this._time_period0.disabled = true;
        this._time_period1.disabled = true;
        this._time_period2.disabled = true;
        ...
        for (const change_indicator of ['up_color', 'down_color', 'updown_color']) {
            this._form.querySelector(`.${ZBX_STYLE_COLOR_PICKER}[color-field-name="${change_indicator}"]`)
    ...
    addLogo() {
        ...
        el.classList.add('initmax-logo');

        this._form.insertBefore(el, this._form.firstChild);
    }
    ...
    updateForm() {
        ...
        for (const element of this._form.querySelectorAll(`#units, #units_pos, #units_size, #units_bold, .${ZBX_STYLE_COLOR_PICKER}[color-field-name="units_color"]`)) {
